  ...
  <body>
	...
	<script type="text/javascript" language="javascript">
		...
		$("#save").click(function(){
			...
			var len = $(".nextWeekWorkPlan").length;
			for(var v = 0; v < len; v++){
				...
				if(nextWeekWorkPlan == "" || nextWeekFinishTime == ""){
					$("#result").val("下周工作计划简述和预计完成时间不能为空.");
					return false;
				}
		...
		$("#saveShow").click(function(){
			...
			if(count == 0){
				...
				var len = $(".showNextWeekWorkPlan").length;
				for(var v = 0; v < len; v++){
					...
					if(nextWeekWorkPlan == "" || nextWeekFinishTime == ""){
						$("#showResult").val("下周工作计划简述和预计完成时间不能为空.");
						return false;
					}
					if(thisWeekWorkPlan == "" || thisWeekFinishTime == ""){
